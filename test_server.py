...
async def test_list_tools():
    ...
    async with await MCPClient.connect(MCP_SERVER_URL) as client:
...
async def main():
    ...
    await test_search_pet()
    await test_search_user()
    await test_updatepet()
    await test_updatepetwithform()
    await test_updateuser()
    await test_uploadfile()
